...
XPOINTS = POINTMULTIPLIER * 4                   # number of points on x-axis on grid (generally higher when you want a borders - more clear)
YPOINTS = POINTMULTIPLIER * 3                   # number of points on y-axis on grid
